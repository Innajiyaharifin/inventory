...
<div class="container bread">
	...
	<div class="container">
			...
			<form enctype ="multipart/form-data" action="proses_tambahstok.php" method="POST">
				...
				<div class="row">
						...
						<div class="form-group">
							...
							<input type="text" name="barang_masuk" class="form-control" >
								...
								<div class="form-group">
									<input type="submit" class="btn-primary btn btn-xs" style="width:100px; height:50px;" value="Input">
								</div>
							</div>
						</div>
					</div>
