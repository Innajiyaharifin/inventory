			...
			<!--<?php// require "sidebar-vendor.php"; ?>-->
				...
				<div class="col-md-12">
							<h1 class="mb20">Produk
									<a href="print.php" class="btn btn-sm btn-success pull-right">Cetak Laporan</a>
				...
				$vendor_id = $_SESSION['user_id'];
							...
							$sql="SELECT t_produk.*, t_kategori.nama_kategori from t_kategori INNER JOIN t_produk on t_produk.kategori_id=t_kategori.id LIMIT $start_from, $per_page";
							$result = $db->query($sql);
