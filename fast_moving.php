		...
		<div class="container content">
			...
			<!--<?php// require "sidebar-vendor.php"; ?>-->
				...
				$vendor_id = $_SESSION['user_id'];
							...
							$sql="SELECT t_produk.* , (select count(sku) from barang_keluar where sku=t_produk.sku and left(tanggal_keluar,7)='2017-03') as total_keluar from t_produk having total_keluar >= 15";
							$result = $db->query($sql);
...
<!--  							<td>
  								...
  								<a href="update-product.php?id=<?= $data['id'] ?>" <i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;
